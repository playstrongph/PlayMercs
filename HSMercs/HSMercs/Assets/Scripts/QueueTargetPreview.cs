...
public class QueueTargetPreview : MonoBehaviour, IQueueTargetPreview
{
    ...
    [SerializeField] private Image damageGraphic;
    [SerializeField] private Image criticalDamageGlow;
    ...
    {
        get => damageGraphic;
        set => damageGraphic = value;
    }
    
    /// <summary>
    /// Critical damage graphic
    /// </summary>
    public Image CriticalDamageGlow
    {
        get => criticalDamageGlow;
        set => criticalDamageGlow = value;
    }
